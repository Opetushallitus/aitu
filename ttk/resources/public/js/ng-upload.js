...
// Taken and modified from https://github.com/twilson63/ngUpload‎
    ...
    return {
      ...
      link: function(scope, element, attrs) {
        element.bind('click', function($event) {
          ...
          //form[0].submit();
          form.submit(); //<- BUGIKORJAUS. Submit ei triggaudu jos tehdään form[0].submit
        });
      }
    };
  }])
    ...
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        element.bind('submit', function uploadStart() {
          bindUploadComplete();   //<- BUGIKORJAUS. Alkuperäinen tapa ei toiminut ie9:llä.
