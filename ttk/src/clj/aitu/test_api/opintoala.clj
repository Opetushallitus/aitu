...
(c/defroutes reitit
  (c/DELETE "/" []
    (db/transaction
      (opintoala-arkisto/tyhjenna!)
      {:status 200}))
  (c/DELETE "/:koodi" [koodi]
    (db/transaction
      (opintoala-arkisto/poista! koodi)
      {:status 200}))
  (c/POST "/" [koodi selite_fi selite_sv koulutusala]
    (db/transaction
      (opintoala-arkisto/lisaa! {:opintoala_tkkoodi koodi
                                 :koulutusala_tkkoodi koulutusala
                                 :selite_fi selite_fi
                                 :selite_sv selite_sv
